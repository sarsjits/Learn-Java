...
/**
 * This example two zap() method implementations that remove strings from a list
 * of strings. One method uses basic Java 7 features and the other uses basic
 * Java 8 features.
 */
public class Java7VsJava8 {
	static public void main(String[] argv) {
		...
		List<String> l1 = zap7(Arrays.asList(nameArray), "Robert");

		// Remove "Robert" from the list created from nameArray.
		List<String> l2 = zap8(Arrays.asList(nameArray), "Robert");
	...
	/**
	 * Remove any strings matching @a omit from the list of strings using basic Java
	 * 7 features.
	 */
	 ...
	 * 8 features.
	 */
	static List<String> zap8(List<String> lines, String omit) {
		return lines
	...
	/**
	 * A generic negation predicate that can be used to negate a predicate.
	 *
